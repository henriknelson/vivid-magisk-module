...
set_permissions() {
  ...
  ui_print "[4/6] Installing to /system/usr/share/vivid..";
  chown -R 0:0 $MODPATH/system/usr/share/vivid;
  chmod -R 755 $MODPATH/system/usr/share/vivid;
  find $MODPATH/system/usr/share/vivid -type d -exec chmod 755 {} \+;
  find $MODPATH/system/usr/share/vivid -type f -exec chmod 644 {} \+;
